...
class VentasModelo{
    public $subtotal; //se ha premitido null en SQL
    public $igv;//se ha premitido null en SQL
    public $resultado;
    ...
    static public function mdlRegistrarVenta($datos,$nro_boleta,$total_venta,$descripcion_venta,$boleta_igv,$boleta_subtotal){

        $stmt = Conexion::conectar()->prepare("INSERT INTO venta_cabecera(nro_boleta,descripcion,total_venta,igv,subtotal)         
                                                VALUES(:nro_boleta,:descripcion,:total_venta,:boleta_igv,:boleta_subtotal)");
        ...
        $stmt -> bindParam(":boleta_igv", $boleta_igv, PDO::PARAM_STR);
        $stmt -> bindParam(":boleta_subtotal", $boleta_subtotal , PDO::PARAM_STR);
